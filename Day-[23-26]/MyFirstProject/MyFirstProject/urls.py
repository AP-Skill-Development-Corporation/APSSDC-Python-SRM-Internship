...
urlpatterns = [
    ...
    path('showall/',views.showall,name="sh"),
    path('usrg/',views.userreg,name="usg"),
    path('usvw/<int:pk>/',views.usvwe,name="usv"),
    path('dltusr/<int:kl>/',views.dlt,name="det"),
    path('ups/<int:pl>/',views.upsr,name="upsd"),
    path('cnt/',views.cntform,name="cntf"),
]
